...
def _build_create_conv() -> ConversationHandler:
...
def _build_addsticker_conv() -> ConversationHandler:
    return ConversationHandler(
        entry_points=[
...
def _build_magic_conv() -> ConversationHandler:
    return ConversationHandler(
        entry_points=[
...
def _build_sync_conv() -> ConversationHandler:
    return ConversationHandler(
        entry_points=[
...
def _build_catalog_search_conv() -> ConversationHandler:
    return ConversationHandler(
        entry_points=[
...
def _build_feature_conv() -> ConversationHandler:
    return ConversationHandler(
        entry_points=[
...
def setup_handlers(application):
    ...
    application.add_handler(_build_create_conv())
    application.add_handler(_build_addsticker_conv())
    application.add_handler(_build_magic_conv())
    application.add_handler(_build_sync_conv())
    application.add_handler(_build_catalog_search_conv())
    application.add_handler(_build_feature_conv())
