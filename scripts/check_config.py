...
if __name__ == "__main__":
    ...
    print(
        "Configuration OK:",
        {
            ...
            "runtime_mode": "DEVELOPMENT" if os.environ.get("APP_ENV", "development") == "development" else "PRODUCTION",
            "telegram_token_source": getattr(settings, "telegram_token_source", "unknown"),
