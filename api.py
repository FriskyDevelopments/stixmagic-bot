...
async def _validate_packs_async(token, user_id):
    ...
    try:
        ...
        # ⚡ Bolt Optimization: Batch database operations using executemany()
        # Impact: Minimizes database round-trips when processing multiple packs, reducing total execution time for bulk operations.
        if updates:
