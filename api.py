...
async def _validate_packs_async(token, user_id):
    ...
    try:
        ...
        valid = []
        # ⚡ Bolt Optimization: Batch SQL updates and deletes to reduce database round-trips
        # Impact: Improves database performance from O(N) to O(1) by batching operations instead of individual executions
        updates = []
        deletes = []
